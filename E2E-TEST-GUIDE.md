...
USE_FAKE_AI=true npx playwright test tests/e2e/01-campaign-creation.spec.ts --reporter=line

# Content creation tests  
USE_FAKE_AI=true npx playwright test tests/e2e/02-content-creation.spec.ts --reporter=line

# AI generation tests
USE_FAKE_AI=true npx playwright test tests/e2e/03-ai-generation.spec.ts --reporter=line
```
