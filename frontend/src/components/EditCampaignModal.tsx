...
export default function EditCampaignModal({
  ...
  useEffect(() => {
    if (isOpen && campaign) {
      ...
      setDefaultLanguage(campaign.defaultLanguage || 'en');
      setSelectedTargetLanguages(campaign.targetLanguages || []);
      setError('');
    }
  }, [isOpen, campaign]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.updateCampaign(campaign.id, {
        name: name.trim(),
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-default-language">Default Language</Label>
